    ...
    ERC20Upgradeable
{
    ...
    // UNISWAP_ROUTER is the contract that handles DEX swap with Uniswap V3 pools
    // https://github.com/Uniswap/v3-periphery/blob/main/contracts/SwapRouter.sol
    address public immutable UNISWAP_ROUTER;

    // PRICE_ORACLE is the contract for Chain Link oracle for USDC vs 
    // underlying asset pair
    address public immutable PRICE_ORACLE;

    // slippage is the max. acceptable slippage for the swap between 
    // USDC and underlying asset
    uint256 public slippage;

    // poolFee is the max. acceptable poolFee for the swap between 
    // USDC and underlying asset
     ...
     * @param _uniswapRouter is the contract address that facilitates gnosis auctions
     * @param _priceOracle is the contract address that facilitates gnosis auctions
     */
    constructor(
        address _weth,
        address _usdc,
