 ...
 */
contract RibbonThetaAltVault is RibbonVault, RibbonThetaVaultStorage {
     ...
     * @param _uniswapRouter is the contract address for swaps with UniswapV3 pools
     * @param _priceOracle is the contract address for swaps with UniswapV3 pools
     */
    constructor(
        address _weth,
        address _usdc,
    ...
    /**
     * @notice Swap the stable collected from premium with underlying asset
     */
    function swapStableForAssets() external onlyKeeper nonReentrant {
        // Get total balance of USDC in the vault
        ...
        emit Swap(USDC, vaultParams.asset, amountIn, amountOut);
    }
    ...
    function _startAuction() private {
        ...
        auctionDetails.assetDecimals = IERC20Detailed(USDC).decimals();
