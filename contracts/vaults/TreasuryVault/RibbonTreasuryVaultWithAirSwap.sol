...
} from "../../libraries/VaultLifecycleTreasuryWithAirSwap.sol";
import {
    ...
    RibbonTreasuryVaultStorage
{
    ...
    /**
     * @notice Optionality to set the Otoken premium manually
     * @param newOtokenPremium is the new premium for each Otoken
     */
    function setCurrentOtokenPremium(uint256 newOtokenPremium)
        public
        onlyKeeper
    {
