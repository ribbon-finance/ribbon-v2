...
library VaultLifecycle {
     ...
     * @param strikeAsset is the address of the strike asset
    ...
    function verifyOtoken(
        ...
        // we just assume all options use strikeAsset as the strike
        require(
