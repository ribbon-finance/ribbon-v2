...
describe("RibbonThetaVault", () => {
  ...
  behavesLikeRibbonOptionsVault({
    ...
    assetContractName: "IWETH",
    strikeAsset: USDC_ADDRESS,
    collateralAsset: UNI_ADDRESS,
    chainlinkPricer: CHAINLINK_UNI_PRICER,
    deltaFirstOption: BigNumber.from("1000"),
    deltaSecondOption: BigNumber.from("1000"),
    deltaStep: BigNumber.from("100"),
    tokenDecimals: 18,
    ...
    mintConfig: {
      contractOwnerAddress: UNI_OWNER_ADDRESS,
    },
  });

  behavesLikeRibbonOptionsVault({
    name: `Ribbon AAVE Theta Vault (Call)`,
    tokenName: "Ribbon AAVE Theta Vault",
    tokenSymbol: "rAAVE-THETA",
    asset: AAVE_ADDRESS,
    assetContractName: "IWETH",
    strikeAsset: USDC_ADDRESS,
    collateralAsset: AAVE_ADDRESS,
    chainlinkPricer: CHAINLINK_AAVE_PRICER,
    deltaFirstOption: BigNumber.from("1000"),
    deltaSecondOption: BigNumber.from("1000"),
    deltaStep: BigNumber.from("100"),
    tokenDecimals: 18,
