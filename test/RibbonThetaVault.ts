    ...
    describe("#commitAndClose", () => {
      ...
      it("sets the correct strike when overriding strike price", async function () {
        const WETH_STRIKE_PRICE = {
          ...
          [CHAINID.AURORA_MAINNET]: 20000000000, // WETH
        };

        const altStrikePrice = BigNumber.from(chainId === CHAINID.AURORA_MAINNET ? "800000000" : "405000000000");
